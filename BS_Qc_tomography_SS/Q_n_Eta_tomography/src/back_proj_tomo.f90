...
implicit none
	...
	character (len=50) :: filename, format_string, Ndd, freq, filename1, format_string1, dumm, iter
	...
	read(*,*) grdsz
	write(*,*) "Input the number of iterations to run:"
	read(*,*) iterations
	write(*,*) "The file name output"
	read(*,*) filename
	...
	!grdsz = 0.2
	!Nd = 585	!no. of traces
	dp = 1.0/float(Nd)	!damping parameter
